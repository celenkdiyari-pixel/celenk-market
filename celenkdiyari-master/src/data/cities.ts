...
export const cities = [
  ...
  {
    name: "Çankırı",
    districts: ["Atkaracalar", "Bayramören", "Çerkeş", "Eldivan", "Ilgaz", "Kızılırmak", "Merkez", "Orta", "Şabanözü", "Yapraklı"]
  },
  {
    name: "Çorum",
  ...
  {
    name: "Ordu",
    districts: ["Akkuş", "Altınordu", "Aybastı", "Çamaş", "Çatalpınar", "Çaybaşı", "Fatsa", "Gölköy", "Gülyalı", "Gürgentepe", "İkizce", "Kabadüz", "Kabataş", "Korgan", "Kumru", "Mesudiye", "Perşembe", "Piraziz", "Ulubey", "Ünye"]
  },
  {
    name: "Osmaniye",
  ...
  {
    name: "Siirt",
    districts: ["Baykan", "Eruh", "Kurtalan", "Merkez", "Pervari", "Şirvan"]
  },
  {
    name: "Sinop",
  ...
  {
    name: "Zonguldak",
    districts: ["Alaplı", "Çaycuma", "Devrek", "Gökçebey", "Kilimli", "Kozlu", "Merkez"]
  }
];
