      ...
      <section className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Çelenk Fiyatları ve Çelenk Gönder Hakkımızda</h1>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              Doğanın en güzel hediyelerini sevdiklerinize ulaştırmak için yola çıktık. 
              Çelenk Diyarı olarak, uygun çelenk fiyatları ve çelenk gönder hizmetimiz ile özel günlerinizi unutulmaz kılmak için buradayız.
            </p>
          </div>
        </div>
      </section>
