// Blog yazılarını Firebase'e ekleme scripti
...
// Bu script admin panelinden veya production'da çalıştırılabilir
// Blog yazılarını eklemek için admin panelinden /admin/blog/create sayfasını kullanın
// veya bu script'i production'da çalıştırın

console.log('📝 Blog yazıları hazır!');
console.log(`Toplam ${blogPosts.length} blog yazısı var.`);
console.log('\nKategoriler:');
